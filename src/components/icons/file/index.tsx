...
const FileIcon = (ArchiveIcon: FileIconProps) => {
    return (
        <svg className={twMerge('fill-white', ArchiveIcon.className)} width="35" height="35" viewBox="-2.5 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="ui-gambling-website-lined-icnos-casinoshunter" transform="translate(-1776.000000, -284.000000)" fill="#1C1C1F" fill-rule="nonzero">
